...
treatment_status <- ifelse(params$primary_tm, "Primary (untreated) tumor", "Recurrent (previously treated) tumor")
...
```{r transloc, fig.align="center", out.width="20%", fig.cap="Somatic translocation events from DNA (left) and RNA (right)", fig.show="hold"}
knitr::include_graphics(c(
  file.path("DELLY", "TR_circos.pdf"),
  file.path("RNAseq_results", "fusions", paste0(params$rnaseq_sample_id, "_circos.pdf"))
))
```
