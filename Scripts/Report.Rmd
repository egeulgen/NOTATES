...
Fanconi anemia is characterized by the inability to repair DNA interstrand cross-links (ICLs) and results in cancer predisposition[^3]. Genes belonging to this pathway, alterations of which would lead to “BRCA-ness" phenotype are reported in this subsection. 
...
if(file.exists("./NOTATES/LOH/CGC_loh.csv"))
{
  ...
  k_tbl <- kable(loh_cgc, format = "latex", booktabs = TRUE, align = "c")
  kable_styling(k_tbl, latex_options = "scale_down")
} else {
  cat("No event to report.")
}
