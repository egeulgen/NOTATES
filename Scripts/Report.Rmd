...
\begin{center}
\includegraphics[width=500pt]{./pathfindR_results/HQ_mutations/{enrichment_chart}.png}
\end{center}

```{r, enr_res_SCNA, echo = F, comment=NA}
...
\begin{center}
\includegraphics[width=500pt]{./pathfindR_results/HQ_SCNA/{enrichment_chart}.png}
\end{center}
