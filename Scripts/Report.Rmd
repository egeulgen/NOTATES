...
- have population Minor Allele Frequency (MAF) < 1% (in 1000 Genomes, ExAC and ESP6500)
...
Any pathogenic/likely-pathogenic germline SNV/indel that affects any of the genes listed in ACMG SF V2.0[^2] are reported under this subsection.
...
Genes in which germline mutations confer highly or moderately increased risks of cancer are called cancer predisposition genes. Germline SNV/indels catalogued in the 2014 Nature publication by Rahman [^3] are reported in this subsection.
...
In this subsection, germline variants reported as "pathogenic" in ClinVar in Human DNA Repair Genes [^4] are presented.
...
### II. e. Other Important Germline Variants

Germline variants in other manually curated genes (alterations of which may carry clinical importance) are reported under this subsection.
