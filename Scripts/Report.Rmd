...
## IV. a. Chromosome Arm-level SCNA Analysis

\begin{center} 
\includegraphics[width=500pt]{chromosome_arm_scna/arm_log2ratio_heatmap.png}
\end{center}
...
`r if(params$type == "glioma") {"## IV. c. Established SCNAs in Glioma"} else {"## IV. c. Established SCNAs in Medulloblastoma"}`
...
## IV. d. SCNAs in Cancer Gene Census Genes
...
fl_name <- file.path("RNAseq_results", "fusions", paste0(params$rnaseq_sample_id, ".fusions.tsv"))
transloc_df <- read.delim(fl_name)
...
## VI. c. LOH Events in Cancer Gene Census Genes 
...
# XI. Glioblastoma Molecular Classification (Verhaak et al.)
