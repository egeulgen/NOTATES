...
## V. a. Chromosome-arm Analysis

\begin{center} 
\includegraphics[width=500pt]{chromosome_arm_scna/arm_copynumber_heatmap.png}
\end{center}

\begin{center} 
\includegraphics[width=500pt]{chromosome_arm_scna/arm_gain_loss_fraction_heatmap.png}
\end{center}
...
`r if(params$type == "glioma") {"## V. c. Established SCNAs in Glioma"} else {"## V. c. Established SCNAs in Medulloblastoma"}`
...
## V. d. SCNAs in Cancer Gene Census Genes
...
Possible somatic translocations based on RNA-sequencing are called using `arriba`. Below is the circos plot displaying possible translocations.
