...
- have a MAF < 1% in gnomAD, ExAC, ESP-6500 and 1000 Genomes projects
- have been not reported as "benign" or "likely benign" in ClinVar
...
if(file.exists("NOTATES/Germline/ACMG.csv")) {
  ...
  # add link to dbSNP
  ACMG_df$rs_id <- ifelse(ACMG_df$rs_id == "", 
                          "",
                          paste0("[", ACMG_df$rs_id, "](", "https://www.ncbi.nlm.nih.gov/snp/", ACMG_df$rs_id, ")"))
...
if(file.exists("NOTATES/Germline/CGC.csv")) {
  ...
  # add link to dbSNP
  gCGC_df$rs_id <- ifelse(gCGC_df$rs_id == "", 
                          "",
                          paste0("[", gCGC_df$rs_id, "](", "https://www.ncbi.nlm.nih.gov/snp/", gCGC_df$rs_id, ")"))
...
if(file.exists("NOTATES/Germline/CPG.csv")) {
  ...
  # add link to dbSNP
  CPG_df$rs_id <- ifelse(CPG_df$rs_id == "", 
                          "",
                          paste0("[", CPG_df$rs_id, "](", "https://www.ncbi.nlm.nih.gov/snp/", CPG_df$rs_id, ")"))
...
if(file.exists("NOTATES/Germline/DDR.csv")) {
  ...
  # add link to dbSNP
  DDR_df$rs_id <- ifelse(DDR_df$rs_id == "", 
                          "",
                          paste0("[", DDR_df$rs_id, "](", "https://www.ncbi.nlm.nih.gov/snp/", DDR_df$rs_id, ")"))
