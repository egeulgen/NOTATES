...
```{r TMB, echo=F, fig.width=10, fig.height=3}
...
```{r imp_som_var, echo = F, comment=NA}
...
# IX. KEGG Pathway Enrichment Analysis
...
### IX. b. KEGG - Pathway Enrichment Results
