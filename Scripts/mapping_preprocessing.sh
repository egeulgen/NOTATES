...
do
	## Alignment
	echo '#############################################'"$name"': Aligning reads from lane: '$i
	...
	echo '#############################################'"$name"': Marking duplicates of lane: '$i
...
if [ $(wc -w <<< "$lanes") != 1 ]
	then
	echo '#############################################'"$name"': Marking duplicates and merging BAM files'
